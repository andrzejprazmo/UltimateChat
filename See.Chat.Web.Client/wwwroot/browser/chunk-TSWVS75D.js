...
_DashboardComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DashboardComponent, selectors: [["app-dashboard"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 4, vars: 1, consts: [[1, "d-flex", "flex-column"], [1, "card"], ["role", "alert", 1, "alert", "alert-info"], [1, "card-body"], [1, "card-title"], [1, "card-footer"], [3, "routerLink"]], template: function DashboardComponent_Template(rf, ctx) {
  if (rf & 1) {
...
//# sourceMappingURL=chunk-TSWVS75D.js.map
