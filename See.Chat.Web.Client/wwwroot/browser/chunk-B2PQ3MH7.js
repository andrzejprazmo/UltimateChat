...
var _DashboardService = class _DashboardService {
  ...
  getChatRooms() {
    const url = `${this.config.hubUrl}/rooms`;
...
function DashboardComponent_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(item_r1.chatRoom);
    \u0275\u0275advance(2);
...
var _DashboardComponent = class _DashboardComponent {
  ...
  setEvents() {
    this.connectionService.initializeConnection().then(() => {
      this.connectionService.connectionHub.on("NewChatRoom", (chatRoom, connectionId) => {
        this.chatRooms.push({ connectionId, chatRoom });
      });
    });
  }
};
...
_DashboardComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DashboardComponent, selectors: [["app-dashboard"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 3, vars: 0, consts: [[1, "d-flex", "flex-column"], [1, "card"], [1, "card-body"], [1, "card-title"], [1, "card-footer"], [3, "routerLink"]], template: function DashboardComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0);
    \u0275\u0275repeaterCreate(1, DashboardComponent_For_2_Template, 7, 4, "div", 1, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275advance();
...
//# sourceMappingURL=chunk-B2PQ3MH7.js.map
