...
var _ChatRoomComponent = class _ChatRoomComponent {
  constructor() {
    ...
    this.route = inject(ActivatedRouteSnapshot);
    this.chatRoom = null;
  }
  ngOnInit() {
    this.chatRoom = this.route.data;
  }
};
_ChatRoomComponent.\u0275fac = function ChatRoomComponent_Factory(t) {
  return new (t || _ChatRoomComponent)();
};
_ChatRoomComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ChatRoomComponent, selectors: [["app-chat-room"]], standalone: true, features: [\u0275\u0275ProvidersFeature([ActivatedRouteSnapshot]), \u0275\u0275StandaloneFeature], decls: 2, vars: 0, template: function ChatRoomComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p");
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ChatRoomComponent, { className: "ChatRoomComponent", filePath: "src\\app\\pages\\chat-room\\components\\chat-room\\chat-room.component.ts", lineNumber: 14 });
})();
export {
  ChatRoomComponent as default
};
//# sourceMappingURL=chunk-GRPHMW2W.js.map
