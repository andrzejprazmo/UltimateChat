...
function getUserAgentHeader() {
  ...
  return [userAgentHeaderName, constructUserAgent(VERSION2, getOsName(), getRuntime(), getRuntimeVersion())];
}
...
_StreamService.\u0275fac = function StreamService_Factory(t) {
  return new (t || _StreamService)();
};
_StreamService.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _StreamService, factory: _StreamService.\u0275fac, providedIn: "root" });
var StreamService = _StreamService;

// src/app/pages/chat-room/components/chat-room/chat-room.component.ts
function ChatRoomComponent_Case_1_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainer(0);
  }
}
function ChatRoomComponent_Case_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, ChatRoomComponent_Case_1_ng_container_0_Template, 1, 0, "ng-container", 3);
  }
  if (rf & 2) {
    \u0275\u0275nextContext();
    const chatRoomQueue_r1 = \u0275\u0275reference(7);
    \u0275\u0275property("ngTemplateOutlet", chatRoomQueue_r1);
  }
}
function ChatRoomComponent_Case_2_Template(rf, ctx) {
}
function ChatRoomComponent_Case_3_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainer(0);
  }
}
function ChatRoomComponent_Case_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, ChatRoomComponent_Case_3_ng_container_0_Template, 1, 0, "ng-container", 3);
  }
  if (rf & 2) {
    \u0275\u0275nextContext();
    const createChatRoomForm_r2 = \u0275\u0275reference(5);
    \u0275\u0275property("ngTemplateOutlet", createChatRoomForm_r2);
  }
}
function ChatRoomComponent_ng_template_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "form", 4);
    \u0275\u0275listener("submit", function ChatRoomComponent_ng_template_4_Template_form_submit_0_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.onSubmit());
    });
    \u0275\u0275elementStart(1, "div", 5)(2, "div", 6)(3, "h4", 7);
...
function ChatRoomComponent_ng_template_6_For_7_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", item_r5.userName, "");
  }
}
function ChatRoomComponent_ng_template_6_ForEmpty_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div")(1, "em");
    \u0275\u0275text(2, "Empty queue...");
    \u0275\u0275elementEnd()();
  }
}
function ChatRoomComponent_ng_template_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 5)(1, "div", 6)(2, "h4", 7);
    \u0275\u0275text(3, "Chat room queue");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "div", 8)(5, "div", 14);
    \u0275\u0275repeaterCreate(6, ChatRoomComponent_ng_template_6_For_7_Template, 2, 1, "a", 15, \u0275\u0275repeaterTrackByIndex, false, ChatRoomComponent_ng_template_6_ForEmpty_8_Template, 3, 0, "div");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance(6);
    \u0275\u0275repeater(ctx_r3.queue);
  }
}
var ChatRoomStatus;
(function(ChatRoomStatus2) {
  ChatRoomStatus2[ChatRoomStatus2["None"] = 0] = "None";
  ChatRoomStatus2[ChatRoomStatus2["Registered"] = 1] = "Registered";
  ChatRoomStatus2[ChatRoomStatus2["Connected"] = 2] = "Connected";
...
var _ChatRoomComponent = class _ChatRoomComponent {
  constructor() {
    ...
    this.queue = [];
    this.chatRoomStatus = ChatRoomStatus.None;
  ...
  setEvents() {
    ...
    this.connectionService.signal$.subscribe((signalData) => {
      this.streamService.signalPeer(signalData.connectionId, signalData.signal, this.videoStream);
    });
    this.streamService.onSignalToSend$.subscribe((data) => {
...
_ChatRoomComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ChatRoomComponent, selectors: [["app-chat-room"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 8, vars: 1, consts: [["createChatRoomForm", ""], ["chatRoomQueue", ""], [1, "d-flex", "flex-row"], [4, "ngTemplateOutlet"], [1, "w-50", 3, "submit", "formGroup"], [1, "card", "m-2"], [1, "card-header"], [1, "card-title"], [1, "card-body"], [1, "form-group"], ["for", "chatRoom"], ["type", "text", "formControlName", "chatRoom", "id", "chatRoom", "placeholder", "Enter chat room name", 1, "form-control"], [1, "card-footer"], ["type", "submit", 1, "btn", "btn-primary"], [1, "list-group"], ["href", "#", 1, "list-group-item", "list-group-item-action"]], template: function ChatRoomComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 2);
    \u0275\u0275template(1, ChatRoomComponent_Case_1_Template, 1, 1)(2, ChatRoomComponent_Case_2_Template, 0, 0)(3, ChatRoomComponent_Case_3_Template, 1, 1);
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, ChatRoomComponent_ng_template_4_Template, 13, 1, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(6, ChatRoomComponent_ng_template_6_Template, 9, 1, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
  }
  if (rf & 2) {
    let tmp_2_0;
    \u0275\u0275advance();
    \u0275\u0275conditional(1, (tmp_2_0 = ctx.chatRoomStatus) === ctx.ChatRoomStatus.Registered ? 1 : tmp_2_0 === ctx.ChatRoomStatus.Connected ? 2 : 3);
  }
}, dependencies: [ReactiveFormsModule, \u0275NgNoValidate, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, FormGroupDirective, FormControlName, CommonModule, NgTemplateOutlet] });
var ChatRoomComponent = _ChatRoomComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ChatRoomComponent, { className: "ChatRoomComponent", filePath: "src\\app\\pages\\chat-room\\components\\chat-room\\chat-room.component.ts", lineNumber: 23 });
})();
export {
...
@angular/forms/fesm2022/forms.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-4LQWLVT4.js.map
